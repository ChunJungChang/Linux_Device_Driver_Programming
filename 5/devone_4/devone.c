...
ssize_t one_write(struct file *filp, const char __user *buf,
...
ssize_t one_read(struct file *filp, char __user *buf,
		size_t count, loff_t *f_ops)
{
	printk("%s called\n", __func__);
...
ssize_t zero_read(struct file *filp, char __user *buf,
		size_t count, loff_t *f_ops)
{
	printk("%s called\n", __func__);
